  ...
  },
  {
    ...
    children: [
      ...
      // { path: 'pages', loadChildren: () => import('./views/pages/routes').then(m => m.routes) },
      {
        ...
        loadChildren: () =>
          import('./features/schedule-lookup/schedule-lookup.module').then(
            (m) => m.ScheduleLookupModule
          ),
      },
      {
        path: 'booking',
      ...
      },
      {
        path: 'carriage-class',
        loadChildren: () =>
          import('./features/carriage-class/carriage-class.module').then(
            (m) => m.CarriageClassModule
          ),
          canActivate: [RoleGuard]
      },
    ],
